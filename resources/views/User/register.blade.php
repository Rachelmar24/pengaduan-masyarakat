...
<div class="container">
    <div class="row justify-content-center">
                <div class="card-body">
                    ...
                    <form action="{{ route('bogor.register') }}" method="POST">
                        @csrf
                        ...
                        <button type="submit" class="btn btn-dark text-white mt-3" style="width: 100%; font-weight: 600">Register</button>
                    </form>
            ...
            @endif
            <a href="{{ route('bogor.index') }}" class="btn btn-dark text-white mt-3" style="width: 100%; font-weight: 600"> Halaman Utama</a>
        </div>
    </div>
</div>
@endsection
