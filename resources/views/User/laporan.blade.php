    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-transparent">
        <div class="container">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ route('bogor.index') }}">
                ...
                <div class="collapse navbar-collapse" id="navbarNav">
                    ...
                    <ul class="navbar-nav text-center ml-auto">
                        ...
                        <li class="nav-item">
                            <a href="{{ route('bogor.formRegister') }}" class="btn btn-outline-purple">Daftar</a>
                        </li>
                    </ul>
                    @endauth
                </div>
...
<div class="container">
            ...
            <div class="content content-top shadow">
                ...
                <form action="{{ route('bogor.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{ old('judul_laporan') }}" name="judul_laporan" placeholder=" Judul Pengaduan"
                            class="form-control">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <input type="text" value="{{ old('tgl_kejadian') }}" name="tgl_kejadian" placeholder=" Tanggal " class="form-control"
                            onfocusin="(this.type='date')" onfocusout="(this.type='text')">
                    </div>
                    <div class="form-group">
                        <textarea name="lokasi_kejadian" rows="3" class="form-control" placeholder="Lokasi ">{{ old('lokasi_kejadian') }}</textarea>
                    </div>
                    <div class="form-group">
            ...
            <div class="content content-bottom shadow">
                <div>
                    ...
                    <div class="row text-center">
                        <div class="col">
                            <p class="italic mb-0">Verifikasi</p>
    ...
    <div class="row mt-5">
        <div class="col-lg-8">
            <a class="d-inline tab {{ $siapa != 'me' ? 'tab-active' : ''}} mr-4" href="{{ route('bogor.laporan') }}">
                Semua
            </a>
            <a class="d-inline tab {{ $siapa == 'me' ? 'tab-active' : ''}}" href="{{ route('bogor.laporan', 'me') }}">
                Laporan Saya
            </a>
            <hr>
        </div>
